...
public interface RedisService {
    ...
    Boolean zAddItem(String key, Object value, Double score);

    Set<Object> zRange(String key,int start,int end);

    Double zUpdateScore(String key, Object value , Double score);

    Long zRemoveValue(String key, Object... values);
